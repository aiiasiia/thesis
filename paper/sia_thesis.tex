...
\chapter{Methodology}
	...
	\section{Improving EMS-GT}
		...
		Working forwards, we then developed a procedure which quickly builds any neighborhood bit-array $N$ in blocks, referring to a pre-generated (using Algorithm 4.1) lookup table of the possible block patterns. This technique was integrated into the existing Java implementation of EMS-GT.
...
\chapter{Results and Analysis}
	...
	\section{Performance improvement with pattern-based speedup technique}
		...
		\subsection{Determining the optimum block size}
			In all previous examples, the block degree $k$ is arbitrarily set to 5. However, as empirical results in Table 4.\ref{tbl:block-degree-tests} show,
			this is actually an optimal value for the $(l,d)$ challenge instances examined in this paper.\newline
