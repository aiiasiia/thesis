...
\chapter{Methodology}
	...
	\section{Improving EMS-GT}
		...
		\section{Exploring features of data structures in EMS-GT}
		Printouts of the bit-array $N$ for certain neighborhoods $N(x,d)$ were generated and examined for features that might allow for further efficiency strategies.
		As recurring patterns in blocks of $N$ emerged, printouts of the underlying distribution of Hamming distances (from $x$ to all other $l$-mers in the search space) were used to derive a proof for the occurrence of these patterns.
